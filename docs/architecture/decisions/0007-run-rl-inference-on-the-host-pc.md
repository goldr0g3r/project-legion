# ADR-0007: Run RL inference on the host PC
...
Host inference; MCU inference; accelerator inference.

## Decision

Keep training and inference on the host for framework flexibility and rapid iteration.
