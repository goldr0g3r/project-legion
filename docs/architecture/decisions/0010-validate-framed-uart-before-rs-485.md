# ADR-0010: Validate framed UART before RS-485
...
UART first; immediate RS-485; Ethernet-based tether.

## Decision

Verify packet semantics and recovery over UART before changing the physical layer.
