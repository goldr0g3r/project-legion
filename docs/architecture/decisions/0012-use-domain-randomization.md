# ADR-0012: Use domain randomization
...
Nominal-only training; domain randomization; online adaptation.

## Decision

Randomize currents, plant coefficients, delays, and sensor properties within documented ranges.
