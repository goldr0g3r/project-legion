# ADR-0004: Select one authoritative plant implementation
...
MATLAB/Simulink authority; Python authority; dual authority.

## Decision

Choose one implementation as authoritative and test any secondary implementation against it.
